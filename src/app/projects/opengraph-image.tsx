    ...
    (
      ...
      >
        ...
        >
          ...
          >
            <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
              <span style={{ fontSize: "9px", fontFamily: "monospace", opacity: 0.4 }}>PROJECT TYPE</span>
              <span style={{ fontSize: "12px", fontWeight: "bold" }}>SYSTEMS &amp; TOOLKITS</span>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
              <span style={{ fontSize: "9px", fontFamily: "monospace", opacity: 0.4 }}>REGISTRY</span>
              <span style={{ fontSize: "12px", fontWeight: "bold" }}>ACTIVE</span>
            </div>
          </div>
        </div>
