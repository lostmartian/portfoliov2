...
const NavLink = ({ href, children, external = false }: { href: string; children: React.ReactNode; external?: boolean }) => (
  <Link
    ...
    className="group flex items-center gap-1 text-grey-400 hover:text-foreground transition-colors py-1"
  >
    ...
    <footer className="relative bg-background pt-16 md:pt-24 lg:pt-32 pb-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-16 space-y-16 md:space-y-24 relative z-10 flex flex-col items-center text-center border-t border-foreground/10 pt-16 md:pt-24">
        ...
        <div className={`w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 text-center ${!isContactPage ? 'pt-16 md:pt-24 border-t border-foreground/5' : ''}`}>
          ...
          <div className="space-y-6 flex flex-col items-center">
            <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-foreground/20">Systems</h4>
            <div className="flex flex-col gap-2 items-center">
          ...
          <div className="space-y-6 flex flex-col items-center">
            <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-foreground/20">Socials</h4>
            <div className="flex flex-col gap-2 items-center">
          ...
          <div className="space-y-6 flex flex-col items-center">
            <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-foreground/20">Status</h4>
            <div className="space-y-4 flex flex-col items-center">
              <div className="flex items-center gap-2">
                <div className="w-1 h-1 rounded-full bg-emerald-500" />
                <span className="text-[10px] font-mono text-emerald-500/80 uppercase tracking-widest">Active</span>
              </div>
              <div className="text-[10px] font-mono text-foreground/30 space-y-1 uppercase tracking-tighter">
        ...
        <div className="w-full pt-8 border-t border-foreground/5 flex flex-col items-center gap-6">
          <div className="space-y-2 flex flex-col items-center">
            <p className="text-[10px] text-foreground/20 font-mono tracking-widest uppercase text-center">
              © 2026 SAHIL GANGURDE — Built for high-fidelity intelligence.
            </p>
          </div>
          <div className="flex items-center gap-8 text-[10px] font-black tracking-[0.4em] text-foreground/10 hover:text-foreground/30 transition-colors uppercase">
            End of Line
          </div>
        </div>
      </div>
