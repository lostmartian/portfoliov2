...
export default async function Image() {
  const project = projects.find((p) => p.slug === "farsight");
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
            ...
            <span style={{ fontSize: "12px", fontFamily: "monospace", opacity: 0.4 }}>
              lostmartian.in/work/farsight ({project.year})
            </span>
          </div>
          ...
          >
            <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
              ...
              <span style={{ fontSize: "12px", fontWeight: "bold" }}>SYSTEMS ARCHITECT</span>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
              <span style={{ fontSize: "9px", fontFamily: "monospace", opacity: 0.4 }}>ENGINE</span>
              <span style={{ fontSize: "12px", fontWeight: "bold" }}>GENERATIVE AI &amp; NEO4J</span>
            </div>
          </div>
        </div>
