    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", width: "100%", zIndex: 10 }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <span style={{ fontSize: "14px", fontFamily: "monospace", letterSpacing: "0.15em", fontWeight: "bold" }}>
              SAHIL GANGURDE // SELECTED PROJECTS
            </span>
          </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "25px", zIndex: 10, maxWidth: "900px", margin: "auto 0" }}>
          ...
          >
            A selective registry of robust systems, high-performance execution solvers, intelligence portals, and developer toolkits.
          </p>
        </div>
        ...
        >
          <div style={{ display: "flex", gap: "40px" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
              <span style={{ fontSize: "11px", fontFamily: "monospace", opacity: 0.4 }}>PROJECT TYPE</span>
              <span style={{ fontSize: "15px", fontWeight: "bold" }}>AI / CODE / EXPERIMENTS</span>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
              <span style={{ fontSize: "11px", fontFamily: "monospace", opacity: 0.4 }}>REPOSITORIES</span>
              <span style={{ fontSize: "15px", fontWeight: "bold" }}>OPEN SOURCE &amp; PROPRIETARY</span>
            </div>
          </div>
          <span style={{ fontSize: "14px", fontFamily: "monospace", opacity: 0.5 }}>
